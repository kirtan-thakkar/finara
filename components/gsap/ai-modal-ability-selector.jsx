...
const abilities = ["vision", "thinking", "code", "speech", "search", "creativity"];
...
export const AiModalAbilitySelector = ({
    ...
    const [selected, setSelected] = useState(["code", "search"]);

    const toggleAbility = (ability) => {
        setSelected(
            (prev) => (prev.includes(ability) ? prev.filter((c) => c !== ability) : [...prev, ability])
        );
    };
                                            ...
                                            {current.length > maxVisible - 1 && (
                                                <Tooltip>
                                                    <TooltipTrigger
                                                        render={
                                                            <div
                                                                className="bg-card flex size-6 items-center justify-center rounded text-xs font-medium shadow">
